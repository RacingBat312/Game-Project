...
def village():
    ...
    while True:    
        ...
        elif answervill in ("Enter blacksmith" , "enter blacksmith" , "Go to blacksmith" , "go to blacksmith"):
           startvillblacksmith()
                       
        elif answervill in ("Enter tavern" , "enter tavern" , "Go to tavern" , "go to tavern"):
           startvilltavern()
